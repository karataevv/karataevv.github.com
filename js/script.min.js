...
"use strict";$(document).ready(function(){$("#top").click(function(){var t=$(this).attr("href");return 0!=$(t).length&&$("html, body").animate({scrollTop:$(t).offset().top},750),!1})}),$(document).ready(function(){$(".scroll__to-features").click(function(){var t=$(this).attr("href");return 0!=$(t).length&&$("html, body").animate({scrollTop:$(t).offset().top},500),!1})}),$(document).ready(function(){$(".scroll__to-lesson").click(function(){var t=$(this).attr("href");return 0!=$(t).length&&$("html, body").animate({scrollTop:$(t).offset().top},500),!1})}),$(".burger-menu").on("click",function(){$(".menu__popup").css({left:"0px",opacity:"1"})}),$(".menu__close").on("click",function(){$(".menu__popup").css({left:"-200%",opacity:"0"})});